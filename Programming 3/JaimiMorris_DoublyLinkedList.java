 ...
 */
public class JaimiMorris_DoublyLinkedList<E> {
	...
	public static void main(String[]args) {
		...
		JaimiMorris_DoublyLinkedList <Integer> list = new JaimiMorris_DoublyLinkedList<Integer>();
		...
		ListIterator<Integer> iter = list.iter();	
		//	list.printAll();
		iter.add(23);
