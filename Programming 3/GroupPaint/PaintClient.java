...
public class PaintClient extends JFrame implements ActionListener {
	...
	private final String IP_ADDRESS = "10.104.13.70";
	...
	public PaintClient() {
		...
		/**
		 * uncomment this line when you are ready to handle coloring elements in the
		 * JList friendList.setCellRenderer(new RowRenderer());
		 */
	...
	private void setUpNetworking() {
		...
		try {
			sock = new Socket("10.104.13.70", 4242);
	...
	public class IncomingReader implements Runnable {
		...
		// this is all done in a separate thread to allow you to read and draw at the
		// same time
		public void run() {

			writer.println("joined:" + me.name + " " + me.color);
			writer.flush();
	...
	public class DrawPanel extends JPanel implements MouseMotionListener {
		...
		public void mouseDragged(MouseEvent mouse) {
			...
			Point curPoint = new Point(mouse.getX(), mouse.getY(), me.color, currentSize);
			points.add(curPoint);
			this.repaint();
			
			writer.println(curPoint);
			writer.flush();
	...
	public class Point {
		...
		public String toString() {
			return xLoc + " " + yLoc + " " + ptColor.getRed() + " " + ptColor.getGreen() + " " + ptColor.getBlue() + " "
					+ ptSize + " ";
		}
	}

	// this class is used to help color code the friends list. Do not edit this
	// class.
	public class Person {
		private String name;
		private Color color;
